...
const ChatWithAI = () => {
  ...
  const renderAdditionalQuestions = () => {
    if (formObj.type === "composition") {
      ...
      }6.必ず、一文くらいの例文と最後に簡単に"一つ一つ"の提案に「～～のようなことを書く段落にするのはどうでしょうか」と書く。）、const answer=[];のシンプルなJSON形式で日本語の値のみの配列を記載してください（/nなど特殊なものは入れないでください）。配列のコード以外の文章やアドバイスは”完全に省いて”ください。あまり情報がなかった場合、勝手にお話を作らないでください。大胆でいいんです！`;
      //作文の場合
      return (
        <>
          <h5>テーマを記入してね</h5>
